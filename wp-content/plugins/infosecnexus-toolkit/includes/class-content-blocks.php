...
final class Content_Blocks {
	...
	public static function register_post_type(): void {
		register_post_type(
			...
			array(
				'labels'       => array(
					'name'          => __( 'Content Blocks', 'infosecnexus-toolkit' ),
					'singular_name' => __( 'Content Block', 'infosecnexus-toolkit' ),
				),
				'public'       => false,
				'show_ui'      => true,
				'show_in_rest' => true,
	...
	public static function add_meta_boxes(): void {
		add_meta_box( 'isnx-content-block-settings', __( 'Display Settings', 'infosecnexus-toolkit' ), array( __CLASS__, 'render_meta_box' ), 'isnx_content_block', 'side' );
	}
	...
	public static function render_meta_box( \WP_Post $post ): void {
		...
		?>
		<p>
			<label for="isnx-block-type"><?php esc_html_e( 'Type', 'infosecnexus-toolkit' ); ?></label>
	...
	private static function block_types(): array {
		return array(
			'hook'            => __( 'Hook', 'infosecnexus-toolkit' ),
			'header'          => __( 'Header', 'infosecnexus-toolkit' ),
			'footer'          => __( 'Footer', 'infosecnexus-toolkit' ),
			'single'          => __( 'Single Template', 'infosecnexus-toolkit' ),
			'archive'         => __( 'Archive Template', 'infosecnexus-toolkit' ),
			'search'          => __( 'Search Template', 'infosecnexus-toolkit' ),
			'no-results'      => __( 'No Results Template', 'infosecnexus-toolkit' ),
			'404'             => __( '404 Template', 'infosecnexus-toolkit' ),
			'popup'           => __( 'Popup', 'infosecnexus-toolkit' ),
			'maintenance'     => __( 'Maintenance Page', 'infosecnexus-toolkit' ),
			'before-content'  => __( 'Before Content', 'infosecnexus-toolkit' ),
			'after-content'   => __( 'After Content', 'infosecnexus-toolkit' ),
			'before-comments' => __( 'Before Comments', 'infosecnexus-toolkit' ),
			'after-comments'  => __( 'After Comments', 'infosecnexus-toolkit' ),
			'footer-fragment' => __( 'Footer Fragment', 'infosecnexus-toolkit' ),
		);
	}
	...
	public static function render_popups(): void {
		foreach ( self::query_blocks( 'popup' ) as $block ) {
			...
			echo '<button type="button" class="isnx-popup__close" data-isnx-popup-close aria-label="' . esc_attr__( 'Close popup', 'infosecnexus-toolkit' ) . '">ÃƒÆ’Ã¢â‚¬â€</button>';
