...
final class Updater {
	...
	/**
	 * Move older installs from temporary/raw endpoints to the latest release manifest.
	 */
	private static function maybe_migrate_manifest_url(): void {
		...
		if ( '' !== $current && ! in_array( $current, array( 'https://infosecnexus.com/updates/infosecnexus-releases.json', 'https://raw.githubusercontent.com/sungjinwoo-vps/isn-theme-plugin-by-yp/stable/dist/infosecnexus-releases.json' ), true ) ) {
			return;
		}
