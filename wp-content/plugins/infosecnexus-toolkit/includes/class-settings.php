				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php esc_html_e( 'Default: https://raw.githubusercontent.com/sungjinwoo-vps/isn-theme-plugin-by-yp/stable/dist/infosecnexus-releases.json', 'infosecnexus-toolkit' ); ?></p>
