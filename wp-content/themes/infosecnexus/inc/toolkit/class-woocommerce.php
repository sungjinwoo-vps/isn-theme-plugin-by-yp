...
final class WooCommerce {
	...
	public static function badge(): void {
		...
		if ( $product->is_on_sale() ) {
			echo '<span class="isnx-product-badge">' . esc_html__( 'Sale', 'infosecnexus' ) . '</span>';
		} elseif ( ! $product->is_in_stock() ) {
			echo '<span class="isnx-product-badge isnx-product-badge--muted">' . esc_html__( 'Out of stock', 'infosecnexus' ) . '</span>';
		}
	}
