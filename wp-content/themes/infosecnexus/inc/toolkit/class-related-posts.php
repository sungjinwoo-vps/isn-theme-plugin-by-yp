...
final class Related_Posts {
	...
	private static function render_image( int $post_id ): void {
		...
		if ( has_post_thumbnail( $post_id ) ) {
			...
			if ( function_exists( '\\InfoSecNexus\\Theme\\Template_Tags\\fallback_image' ) ) {
				echo \InfoSecNexus\Theme\Template_Tags\fallback_image( $post_id, array( 'sizes' => '(max-width: 760px) calc(100vw - 32px), (max-width: 1180px) 31vw, 360px' ) );
			} else {
