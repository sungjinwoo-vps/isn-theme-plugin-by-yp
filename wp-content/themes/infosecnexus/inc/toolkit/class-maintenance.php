...
final class Maintenance {
	...
	public static function maybe_render(): void {
		...
		get_header();
		echo '<main id="primary" class="site-main"><section class="not-found"><h1>' . esc_html__( 'Maintenance in progress', 'infosecnexus' ) . '</h1>';
		if ( ! Content_Blocks::render_location( 'maintenance' ) ) {
			echo '<p>' . esc_html__( 'InfoSecNexus is being updated. Please check back soon.', 'infosecnexus' ) . '</p>';
		}
		echo '</section></main>';
		get_footer();
		exit;
